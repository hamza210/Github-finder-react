...
function User() {
    ...
    const {name,type,avatar_url,location,bio,blog,twitter_username,login,html_url,followers,following,public_gists,public_repos,hireable} = user
        ...
        <div className='grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 mb-8 md:gap-8'>
          <div className='custom-card-image mb-6 md:mb-0'>
            <div className='card rounded-lg shadow-xl image-full'>
              ...
              <div className='card-body justify-end cus'>
